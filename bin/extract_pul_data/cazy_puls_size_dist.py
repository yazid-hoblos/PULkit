...
This script analyzes the size distribution of PULs extracted from CAZy
and creates comparative bar plots
"""
...
def main():
    ...
    parser.add_argument("-o", "--output", default="pul_size_distribution.png",
