...
def main():
    # cazy_path = "../report/cazy_curated/Prevotella_denticola_merged.tsv"
    cazy_path = "../report/Bt_empirical_PULs.tsv"
    cazy_df = load_cazy_curated(cazy_path)

    # projection_dir = "../report/all_prev_systems_tp_only/Prevotella_denticola/dbcan-merged-corrected/projection/"
    # projection_dir = "../report/verify2/denti/dbcan-merged-corrected/projection/"
    projection_dir = "../report/Bt-filtered/"
